...
/**
 * Created by hunter on 2017/12/13.
...
public class JDBCLoader implements BulkLoaderErrorHandler{
    ...
    public static void main(String[] args) throws IOException {
        ...
        //分解入参
        cfg.parse(JDBCLoader.class.getName(), args);  // 重点要看
        m_config = cfg;
        ...
        try {
            ...
            if(m_config.useSuppliedProcedure) {
                ...
                dataLoader = new CSVBulkDataLoader((ClientImpl) csvClient, m_config.table,
                        m_config.batch, m_config.update, errHandler);
            }
    ...
    private static Client getClient(ClientConfig c_config, String[] servers, int port) throws Exception {
        c_config.setTopologyChangeAware(true);
        final Client client = ClientFactory.createClient(c_config);
